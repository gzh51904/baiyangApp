<template>
  <div style="over-flow:auto">
    ...
    <div class="modifyBox" v-if="MSGbox">
      ...
      <div>
        <span>库存</span>
        <input type="text" v-model="goods.xiaoliang">
        <br>
      </div>
      <div>
        <span>数量</span>
        <input type="text" v-model="goods.qty">
      </div>
      <div>
        <span>图片</span>
        <input type="text" v-model="goods.imgurl">
      </div>
...
export default {
  ...
  methods: {
    ...
    confirm() {
      ...
      this.goodsList[this.currentIdx].price = this.goods.price
        ? this.goods.price
        : this.goodsList[this.currentIdx].price;
      this.goodsList[this.currentIdx].xiaoliang = this.goods.xiaoliang
        ? this.goods.xiaoliang
        : this.goodsList[this.currentIdx].xiaoliang;
      this.goodsList[this.currentIdx].qty = this.goods.qty
        ? this.goods.qty
        : this.goodsList[this.currentIdx].qty;
      this.goodsList[this.currentIdx].imgurl = this.goods.imgurl
        ? this.goods.imgurl
        : this.goodsList[this.currentIdx].imgurl;
      ...
      let params = { name, price, xiaoliang, qty, imgurl, id };
      console.log(params);
