<template>
  <div style="over-flow:auto">
    ...
    <div class="modifyBox" v-if="MSGbox">
      <div>
        <span>商品名称</span><input type="text" v-model="goods.goodsname">
        <span>商品价格</span><input type="text" v-model="goods.price">
        <span>库存</span><input type="text" v-model="goods.xiaoliang">
