<template>
  <div style="over-flow:auto">
    ...
    <div class="modifyBox" v-if="MSGbox">
        ...
        <div>
        <span>图片</span><input type="text" v-model="goods.qty">
        </div>
...
_delete.on('click',()=>{
  ...
  methods: {
   ...
   this.MSGbox = false;
    ...
    confirm(){
      this.goodsList[this.currentIdx].name =this.goods.goodsname ? this.goodsList[this.currentIdx].name:goods.goodsname;
      this.goodsList[this.currentIdx].price =this.goods.price ? this.goodsList[this.currentIdx].price:goods.price;
      this.goodsList[this.currentIdx].xiaoliang =this.goods.xiaoliang ? this.goodsList[this.currentIdx].xiaoliang:goods.xiaoliang;
      this.goodsList[this.currentIdx].qty =this.goods.qty ? this.goodsList[this.currentIdx].qty:goods.qty;
      this.goodsList[this.currentIdx].imgurl =this.goods.imgurl ? this.goodsList[this.currentIdx].imgurl:goods.imgurl;
      var id = this.currentIdx;
   ...
   this.$axios.put("/api/goods/"+id, {params}).then(({ data }) => {
      console.log(data)
