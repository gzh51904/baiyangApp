...
_delete.on('click',()=>{
  ...
  methods: {
   ...
   this.MSGbox = false;
    ...
    confirm(){
      this.goodsList[this.currentIdx].name =goods.goodsname ? this.goodsList[this.currentIdx].name:goods.goodsname;
      this.goodsList[this.currentIdx].price =goods.price ? this.goodsList[this.currentIdx].price:goods.price;
      this.goodsList[this.currentIdx].xiaoliang =goods.xiaoliang ? this.goodsList[this.currentIdx].xiaoliang:goods.xiaoliang;
      this.goodsList[this.currentIdx].qty =goods.qty ? this.goodsList[this.currentIdx].qty:goods.qty;
      this.goodsList[this.currentIdx].imgurl =goods.imgurl ? this.goodsList[this.currentIdx].imgurl:goods.imgurl;
      ...
      let imgurl =  this.goodsList[this.currentIdx].qty;
