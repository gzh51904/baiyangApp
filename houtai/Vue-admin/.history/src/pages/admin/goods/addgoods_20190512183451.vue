<template>
   <div >
        <div class="row">
        <span>商品名称:</span><input type="text" v-model="goods.name"><br/>
        </div>
        <div class="row">
        <span>商品价格:</span><input type="text" v-model="goods.price"><br/>
          </div>
          <div class="row">
        <span>商品原价:</span><input type="text" v-model="goods.del_price"><br/>
          </div>
         <div class="row">
        ...
        <div class="confirmation">
          ...
          <button @click="confirm" class="btn-sucess">确认添加</button>
        </div>
