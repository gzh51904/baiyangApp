...
_delete.on('click',()=>{
  ...
  methods: {
   ...
   this.MSGbox = false;
    ...
    confirm(){
      this.goodsList[this.currentIdx].name =this.goods.goodsname ? this.goodsList[this.currentIdx].name:this.goods.goodsname;
      this.goodsList[this.currentIdx].price =this.goods.price ? this.goodsList[this.currentIdx].price:this.goods.price;
      this.goodsList[this.currentIdx].xiaoliang =this.goods.xiaoliang ? this.goodsList[this.currentIdx].xiaoliang:this.goods.xiaoliang;
      this.goodsList[this.currentIdx].qty =this.goods.qty ? this.goodsList[this.currentIdx].qty:this.goods.qty;
      this.goodsList[this.currentIdx].imgurl =this.goods.imgurl ? this.goodsList[this.currentIdx].imgurl:this.goods.imgurl;
