<template>
  <div class="topic">
    <div class="topic_pic" @click="jumpToSpecialPage(oTopic2.special_id)">
      <img :src="oTopic2.bigImg" alt="#">
    </div>
    <div class="topic_goods">
      <ul class="goods_list">
        <li class="list_item" v-for="item in oTopic2.goodsList" :key="item.id" @click="jumpToDetailPage(item.id)">
          <div class="goods_pic">
...
export default {
  data() {
    return {
      oTopic2: {
        special_id: 16,
        bigImg: require("../../assets/img/special16.png"),
        goodsList: []
      }
    };
  },
  ...
  created() {
    this.getSpecialDatas("逆龄养颜", this.oTopic2);
  }
};
</script>
