<template>
  <div class="topic">
    <div class="topic_pic" @click="jumpToSpecialPage(oTopic3.special_id)">
      <img :src="oTopic3.bigImg" alt="#">
    </div>
    <div class="topic_goods">
      <ul class="goods_list">
        <li class="list_item" v-for="item in oTopic3.goodsList" :key="item.id" @click="jumpToDetailPage(item.id)">
          <div class="goods_pic">
...
export default {
  data() {
    return {
      oTopic3: {
        special_id: 17,
        bigImg: require("../../assets/img/special17.png"),
        goodsList: []
      }
    };
  },
  ...
  created() {
    this.getSpecialDatas("增肌", this.oTopic3);
  }
};
</script>
