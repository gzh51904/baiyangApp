<template>
  <div class="topic">
    <div class="topic_pic" @click="jumpToSpecialPage(oTopic6.special_id)">
      <img :src="oTopic6.bigImg" alt="#">
    </div>
    <div class="topic_goods">
      <ul class="goods_list">
        <li class="list_item" v-for="item in oTopic6.goodsList" :key="item.id" @click="jumpToDetailPage(item.id)">
          <div class="goods_pic">
...
export default {
  data() {
    return {
      oTopic6: {
        special_id: 20,
        bigImg: require("../../assets/img/special20.png"),
        goodsList: []
      }
    };
  },
  ...
  created() {
    this.getSpecialDatas("儿童玩具", this.oTopic6);
  }
};
</script>
