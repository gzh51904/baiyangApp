<template>
  <div class="topic">
    <div class="topic_pic" @click="jumpToSpecialPage(oTopic5.special_id)">
      <img :src="oTopic5.bigImg" alt="#">
    </div>
    <div class="topic_goods">
      <ul class="goods_list">
        <li class="list_item" v-for="item in oTopic5.goodsList" :key="item.id" @click="jumpToDetailPage(item.id)">
          <div class="goods_pic">
...
export default {
  data() {
    return {
      oTopic5: {
        special_id: 19,
        bigImg: require("../../assets/img/special19.png"),
        goodsList: []
      }
    };
  },
  ...
  created() {
    this.getSpecialDatas("心脑保健", this.oTopic5);
  }
};
</script>
