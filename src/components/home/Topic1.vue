<template>
  <div class="topic">
    <div class="topic_pic" @click="jumpToSpecialPage(oTopic1.special_id)">
      <img :src="oTopic1.bigImg" alt="#">
    </div>
    <div class="topic_goods">
      <ul class="goods_list">
        <li class="list_item" v-for="item in oTopic1.goodsList" :key="item.id" @click="jumpToDetailPage(item.id)">
          <div class="goods_pic">
...
export default {
  data() {
    return {
      oTopic1: {
        special_id: 15,
        bigImg: require("../../assets/img/special15.png"),
        goodsList: []
      }
    };
  },
  ...
  created() {
    this.getSpecialDatas("面部护理", this.oTopic1);
  }
};
</script>
