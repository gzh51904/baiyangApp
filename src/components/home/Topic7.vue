<template>
  <div class="topic">
    <div class="topic_pic" @click="oTopic7.special_id">
      <img :src="oTopic7.bigImg" alt="#">
    </div>
    <div class="topic_goods">
      <ul class="goods_list">
        <li class="list_item" v-for="item in oTopic7.goodsList" :key="item.id" @click="jumpToDetailPage(item.id)">
          <div class="goods_pic">
...
export default {
  data() {
    return {
      oTopic7: {
        special_id:21,
        bigImg: require("../../assets/img/special21.png"),
        goodsList: []
      }
    };
  },
  ...
  created() {
    this.getSpecialDatas("家庭常备", this.oTopic7);
  }
};
</script>
