<template>
    <div class="topic">
        <div class="topic_pic" @click="jumpToSpecialPage(oTopic8.special_id)">
            <img :src="oTopic8.bigImg" alt="#">
        </div>
        <div class="topic_goods">
            <ul class="goods_list">
                <li class="list_item" v-for="item in oTopic8.goodsList" :key="item.id" @click="jumpToDetailPage(item.id)">
                    <div class="goods_pic">
...
export default {
  data() {
    return {
      oTopic8: {
        special_id:22,
        bigImg: require("../../assets/img/special22.png"),
        goodsList: []
      }
    };
  },
  ...
  created() {
    this.getSpecialDatas("亲肤有道", this.oTopic8);
  }
};
</script>
